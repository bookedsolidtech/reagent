...
The gateway uses Koa-style onion middleware where each layer wraps the next. This means audit (outermost) captures everything, including denials from inner layers.
